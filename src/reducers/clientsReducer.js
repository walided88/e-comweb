...
const clientsSlice = createSlice({
    ...
    reducers: {
        ...
        addConnected: (state, action) => {
            state.listConnected.push(action.payload);
        },
...
export const { setClients, addClient, updateClient, deleteClient, getClient, getName, addMessage, deleteMessage,addConnected } = clientsSlice.actions;
