...
const userSlice = createSlice({
    ...
    reducers: {
        ...
        deletProduct: (state, action) => {
            state.users = state.productList.filter(prod => prod.id !== action.payload);
        },
...
export const { setUsers, setCurrentUser,updateProducts, addUser, updateUser,setCurrentAdds, deleteUser,prodSelected,addProducts,setIndex,rebootList,deletProduct } = userSlice.actions;
